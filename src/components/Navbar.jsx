...
const Navbar = () => {
  ...
  return (
    <div className='flex sticky top-0 items-center justify-between py-5 font-medium bg-white z-50 shadow-[rgba(0,0,15,0.1)_0px_2px_0px_0px]'>
        ...
        <div className='flex items-center gap-6'>
          ...
          <Link to="/cart" className='relative'>
            ...
            aspect-square rounded-full text-[8px]'>0{getCartCount()}</p>
          </Link>
